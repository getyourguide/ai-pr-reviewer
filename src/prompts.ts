...
The last line of each review comment must include a unique importance score as a floating point value between 0.0 and 1.0, where a higher number denotes higher importance. Ensure that every importance score is distinct, so that the feedback comments can be sorted. Examples of high importance comments include critical issues, security vulnerabilities, and major bugs. Examples of low importance comments include minor issues, code style, and best practices.
